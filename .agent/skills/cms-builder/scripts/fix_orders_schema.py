...
def fix_orders_schema():
    ...
    for idx in current_indexes:
        if 'UNIQUE' in idx and ('stripe_session_id' in idx or 'stripe_payment_intent' in idx):
    ...
    resp = requests.patch(update_url, headers=headers, json=update_payload, verify=False, timeout=30)
