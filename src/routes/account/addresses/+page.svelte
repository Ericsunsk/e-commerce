<script lang="ts">
        ...
        try {
            ...
            if (editingAddress) {
                ...
                await pb
                    ...
                    .update(editingAddress.id, addressData);
    ...
    async function setAsDefault(id: string) {
        ...
        try {
            ...
            toastStore.show(
                MESSAGES.SUCCESS.DEFAULT_ADDRESS_UPDATED,
                "success",
            );
            await loadAddresses();
        } catch (e) {
    ...
    <div class={LAYOUT.contentWrapper}>
                ...
                <form onsubmit={saveAddress} class="space-y-6">
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label
                                for="addr-label"
                                class="block text-[10px] uppercase tracking-[0.15em] mb-2"
                    ...
                    <label class="flex items-center gap-3 cursor-pointer">
                        <input
                            ...
                            class="w-4 h-4"
                        />
                        <span class="text-[10px] uppercase tracking-[0.15em]"
        ...
        {:else if addresses.length === 0}
            <div class={LAYOUT.emptyState}>
                <p class="text-xl font-display uppercase tracking-widest mb-4">
                    No Addresses
                </p>
                <p class="text-sm {COLORS.textMuted} mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {#each addresses as address (address.id)}
                    ...
                    >
                        ...
                        {#if address.phone}
                            <p
                                class="text-sm text-primary/60 dark:text-white/60 mt-2"
                            >
                                {address.phone}
                            </p>
                        {/if}
                        ...
                        <div
                            class="flex gap-4 mt-6 pt-4 border-t border-primary/10 dark:border-white/10"
                        >
                            <button
