<script lang="ts">
    ...
    let material = $derived(
        (data.product.attributes?.material as string) ?? "",
    );
    let details = $derived(
        (data.product.attributes?.details as string[]) ?? [],
    );
...
{:else}
    ...
    <div class="lg:flex lg:gap-12 xl:gap-24">
        ...
        <div class="lg:w-[60%] xl:w-[65%] flex flex-col gap-1">
            ...
            <div
                class="flex lg:hidden overflow-x-auto snap-x snap-mandatory gap-1 scrollbar-hide"
            >
