...
export const BUTTON_STYLES = {
    // 轮廓按钮 (最常用)
    outline: "border border-primary dark:border-white text-primary dark:text-white hover:bg-primary hover:text-white dark:hover:bg-white dark:hover:text-primary transition-colors duration-300",

    // 实心按钮
    solid: "bg-primary text-white dark:bg-white dark:text-primary hover:opacity-90 transition-opacity",
...
export const LAYOUT = {
    // Page layouts
    pageContainer: "min-h-screen bg-background-light dark:bg-background-dark pt-[var(--content-offset)]",
...
export const CONTENT_IMAGES = {
    // 空状态图片
    WISHLIST_EMPTY: "https://images.unsplash.com/photo-1445205170230-053b83016050?q=80&w=2000&auto=format&fit=crop",
    CART_EMPTY: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?q=80&w=2000&auto=format&fit=crop",

    // About 页面
    ABOUT_HERO: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=2000&auto=format&fit=crop",
    ABOUT_SECTION: "https://images.unsplash.com/photo-1509631179647-0177331693ae?q=80&w=2000&auto=format&fit=crop",

    // 首页
    HOME_HERO: "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?q=80&w=2000&auto=format&fit=crop",
    HOME_STORY: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=2000&auto=format&fit=crop",

    // SEO / Open Graph
    OG_DEFAULT: "https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=1200&auto=format&fit=crop",
} as const;
...
// =============================================================================
// POCKETBASE COLLECTIONS - 数据集合名称常量
// =============================================================================
