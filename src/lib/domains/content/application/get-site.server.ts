import { getFileUrl, DEFAULTS, CONTENT_IMAGES } from '$shared/kernel';
import type { GlobalSettings, NavItem } from '../domain/models';
import { Collections } from '$shared/infrastructure';
import { withAdmin } from '$shared/infrastructure/server';
import { getAssetUrl } from './get-page.server';
