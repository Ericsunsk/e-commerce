...
<section class="grid grid-cols-1 md:grid-cols-2 h-auto md:h-[80vh]">
    <div class="relative overflow-hidden min-h-[400px] md:min-h-0">
        <RemoteImage
        ...
        >
            <span
                class="text-[10px] uppercase tracking-[0.2em] text-white/40 font-bold"
            >
                Story
            </span>
        </div>
    ...
    <div
        class="bg-white dark:bg-zinc-900 flex flex-col justify-center p-12 md:p-24"
    >
        <h2
            class="text-3xl md:text-5xl font-display leading-tight mb-8 text-text-main dark:text-white"
        >
            {section.heading}
        </h2>
        <div
            class="text-sm md:text-base text-primary dark:text-white leading-relaxed tracking-widest mb-10 max-w-md [&>p]:mb-4 last:[&>p]:mb-0"
        >
