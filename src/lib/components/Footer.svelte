...
>
    ...
    >
        ...
        <div class="w-full max-w-md">
            <h4
                class="text-sm font-serif font-medium mb-0 tracking-wide text-primary dark:text-white"
            >
                Join the Conversation
            </h4>
            <form
                class="relative border-none outline-none"
        ...
        >
            <button
                class="flex items-center gap-1 hover:opacity-60 {TRANSITIONS.opacity} cursor-pointer"
            >
