...
<section
    class="py-24 px-6 md:px-12 bg-background-light dark:bg-background-dark"
>
    <div class="max-w-[1600px] mx-auto">
        <div class="flex flex-col md:flex-row md:justify-between md:items-end gap-4 md:gap-0 mb-8 md:mb-12">
            <div>
        ...
        {#if products.length > 0}
            <div class="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-8 md:gap-8">
